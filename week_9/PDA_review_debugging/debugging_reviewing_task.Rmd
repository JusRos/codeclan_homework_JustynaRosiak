...
1. Ensure the code is doing what is described in the goal description
2. Fix any bugs/errors that occur in the code
3. Rewrite parts/whole code to be written in a more efficient manner (think about thinks like not creating unnecessary objects, using tidyverse verbs and piping, making code as easy to read and understand). 
