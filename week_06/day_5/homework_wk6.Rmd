...
```
Answer: The p value has been rounded to 0 and as p value is lower than significance level of 0.05 this provided enough evidence to reject H0. The mean sleep_total differs from the Jabberwockie's sleep avearage.
...
Answer: P_value is greater than the significance level of 0.05 and this is enough evidence to reject H1 in favour of H0. On average omnivores are sleeping less or the same as herbivores.
...
**H0:** Population of domesticated anmials is less or equals to 5% of the whole population of animals.
...
```
Answer: P-value is less than significant value of 0.05, therefore we have enough evidence for rejecting H0 in favour of H1. Based on data, the population of domesticated animals is greater than 5% of the animal types population.
...
As the p-value is significantly lower than the significance level that was set up at 0.01, we have enough evidence to reject H0.In other words - the website users wre more likely to click on the banner positioned at the top of the website than when it was positioned on the right hand side.
...
As the p-value is slightly higher than the significance level we set up at 0.05, we do not have suficient evidence to reject H0. In other words - the results suggest that the parts do not differ significantly from 145mm width on average. It is possible that any observed differences could be teh result of chance or random variation.
