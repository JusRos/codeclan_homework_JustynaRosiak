...
Density has improved the model only very slightly as now around 24 % of variance in the quality can be explained by all three variables - alcohol, volatile_acidity and density.
